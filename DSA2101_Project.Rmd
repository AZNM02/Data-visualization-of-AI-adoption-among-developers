...
- **Career Profile**: Developers' professional background such as years of professional coding experience (`years_code_pro`), job role (`dev_type`) and other work-related factors.
...
```
However, only 72% of respondents expressed a favorable sentiment toward AI adoption, despite its high adoption rate.
...
```
Furthermore, only 70% of developers perceive AI as non-threatening to their roles.
...
Summaryhigh = data.frame(
  ...
  Proportion = c('0.9318182','0.9411765','0.8364940','0.8829632'))
